...
We have used .env file in the root directory for environment variables.
```
COMET_API_KEY=<apikey>
LOG_FILE=./flask.log
```
The method should also work if you have set the above variables in os environment variables.
